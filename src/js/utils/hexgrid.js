// src: https://github.com/rrreese/Hexagon.js
// License: MIT
...
function HexagonGrid (canvasId, radius) {
  ...
  this.canvas = canvasId instanceof HTMLElement ? canvasId : document.getElementById(canvasId);
  ...
  this.setColors('#ddd', '#000');
}

HexagonGrid.prototype.setColors = function (tileColor, borderColor) {
