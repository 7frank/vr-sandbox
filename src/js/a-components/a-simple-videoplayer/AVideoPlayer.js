// @author {@link https://github.com/etiennepinchon/aframe-videoplayer}
// @author frank1147 minor changes to be able to use it as a component
export var AVideoPlayer = function (target, videoEl) {
  // Vals
  this.duration = 0;
  ...
  this._initElements = function () {
    this.elProgressBar = target.querySelector('#progress-bar');
    this.elProgressTrack = target.querySelector('#progress-bar-track');
    this.elProgressFill = target.querySelector('#progress-bar-fill');
    this.elAlertSound = document.querySelector('#alert-sound');
    this.elVideo = videoEl;
    this.elVideoScreen = target.querySelector('#video-screen');
    this.elControlBack = target.querySelector('#control-back');
    this.elControlPlay = target.querySelector('#control-play');
    this.elControlVolume = target.querySelector('#control-volume');
  };
