...
if (typeof AFRAME === 'undefined') {
  throw new Error('mouse-cursor Component attempted to register before AFRAME was available.');
}
...
AFRAME.registerComponent('mouse-cursor', {
  ...
  /**
     ...
     */
  init () {
    this._raycaster = this.el.components.raycaster.raycaster;// new THREE.Raycaster()
